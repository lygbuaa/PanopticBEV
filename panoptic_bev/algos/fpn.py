...
class InstanceSegAlgoFPN(InstanceSegAlgo):
    ...
    def _head(self, head, x, proposals, proposals_idx, img_size, do_cls_bbx, do_msk):
        ...
        logger.debug("InstanceSegAlgoFPN, rois: {}".format(rois.shape))
    ...
    def inference(self, head, x, proposals, valid_size, img_size):
        ...
        try:
            ...
            logger.debug("PredictionGenerator, bbx_pred: {}, cls_pred: {}, obj_pred: {}".format(bbx_pred.contiguous[0], cls_pred.contiguous[0], obj_pred.contiguous[0]))
            ...
            logger.debug("InstanceSegAlgoFPN, FPNMaskHead-2, msk_logits: {}".format(msk_logits.shape))
