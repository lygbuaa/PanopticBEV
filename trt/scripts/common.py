...
# copy this script from TensorRT/samples/python/common.py
...
def allocate_buffers(engine):
    ...
    for binding in engine:
        ...
        if engine.binding_is_input(binding):
            ...
            # print("[allocate_buffers] binding input: size {}, dtype {}".format(size, dtype))
        else:
            outputs.append(HostDeviceMem(host_mem, device_mem))
            # print("[allocate_buffers] binding output: size {}, dtype {}".format(size, dtype))
